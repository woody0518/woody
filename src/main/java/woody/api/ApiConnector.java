...
public class ApiConnector {
    ...
    public void getInitData(int animeCount,int featureCount,int advertiseCount,VolleyListener listener){
    ...
    public void getCategory(int categoryId,int page,int count,VolleyListener listener){
        long timeStamp = System.currentTimeMillis() / 1000L;
        TreeMap<String,String> params = new TreeMap<String, String>();
        params.put("api_key",API_KEY);
        params.put("timestamp",String.valueOf(timeStamp));
    ...
    public void getCategoryRecommend(int categoryId,int count,VolleyListener listener){
        long timestamp = System.currentTimeMillis()/1000L;
        TreeMap<String,String> params = new TreeMap<String, String>();
        params.put("api_key",API_KEY);
        params.put("timestamp",String.valueOf(timestamp));
