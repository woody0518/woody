...
package woody.widget.wheelview;
...
//			int layoutTop = itemsLayout.getTop();
//			int center = layoutTop + itemsLayout.getHeight() / 2;
//			int scrollY = scroller.getScrollY();
//			Log.e("", ""+scrollY);
//			for (int i = 0; i < childCount; i++) {
//				TextView item = (TextView) itemsLayout.getChildAt(i);
//				int itemTop = item.getTop();
//				if(itemTop < center){
//					float alpha = (float)itemTop / (float)center;
//					item.setTextColor(Color.argb((int) (alpha * 255), 99, 99, 99));
//				}else{
//					float alpha = 1 - (float)(itemTop - center) / (float)center;
//					item.setTextColor(Color.argb((int) (alpha * 255), 99, 99, 99));
//				}
//			}
    ...
    public void setInitionIndex(int index) {
        this.initionIndex = index;
    }

    public void back() {
        setCurrentItem(initionIndex);
    }
