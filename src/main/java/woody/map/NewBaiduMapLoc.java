...
public class NewBaiduMapLoc {
	...
	private NewBaiduMapLoc() {}
	
	private static NewBaiduMapLoc mBaiduMapLoc = new NewBaiduMapLoc();
	public static NewBaiduMapLoc getInstance() {
		return mBaiduMapLoc;
	}

	public void initBaiduLoc(Context context,final TextView mCityLocate) {
